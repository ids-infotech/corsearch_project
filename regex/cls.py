            ...
            for match in registration_pattern.finditer(pdf_text):
                ...
                if match_511:
                    ...
                    for part in classification_parts:
                        ...
                        match_number = re.match(r"^\d+", part)
                        if match_number:
                            ...
                            nice_classes = match_number.group(0)
                            goods_service_description = part[len(nice_classes):].strip()
                        else:
...
with open("cls.json", "w", encoding='utf-8') as output_file:
