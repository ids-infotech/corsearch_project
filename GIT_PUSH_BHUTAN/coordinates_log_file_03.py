...
def update_structure_with_clippings_BHUTAN(input_structure_file, input_clippings_file, output_structure_file, log_file):
    ...
    nested_keys = headings = ["Madrid mark", "National mark"]  # Add your actual nested keys
