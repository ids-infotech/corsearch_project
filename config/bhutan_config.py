...
if dates_covered and sections_to_extract and jurisdiction_code:
    ...
    # Modified file name using jurisdiction code
    json_file_name = f"{jurisdiction_code}_config.json"  # Replacing the dynamic format with a specific format
 ...
 # Store non-nested attribute directly
    ...
    # Save the combined JSON output to a file with a dynamic file name like this (jurisdiction code)_config.json
